...
class Libros extends Controller
{
    ...
    public function listar() //obtiene y retorna desde el modelo
    {
    ...
    public function registrar()  //inserta o actualiza 
    {
    ...
    public function eliminar($id) //cambia estado
    {
    ...
    public function verificar($id_libro) //cantidad
    {
