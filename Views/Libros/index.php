           ...
           <div class="tile-body">
               <div class="row invoice-info d-flex">
                <div class="col-8 text-left input-group" id="botonesContainer">
                 ...
                 <!-- Seccion para registrar un nuevo libro -->
                <div class="col-4 text-right d-flex">
               <h5 class="title_max-width992 "><i class="fa fa-list"></i>&nbsp;Lista de Libros/</h5>
...
<div class="row">
    ...
    <h5 class="title_max-width767 text-center" ><i class="fa fa-list"></i>&nbsp;Lista de Libros</h5>
            <div class="tile-body">
...
<!-- modal que se abre al hacer click en nuevo o editar-->
